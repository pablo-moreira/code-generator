...
public class WinFrmEntity extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		cbbGender.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
	...
	private void save() {
		...
		if (cmGender.getSelectedEntity() == null) {
			JFrameUtils.showErro("Erro de validação",
					"O Gênero não foi informado!");
			return;
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(WinFrmEntity.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				WinFrmEntity dialog = new WinFrmEntity(
